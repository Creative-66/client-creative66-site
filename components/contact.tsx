...
export default function ContactForm() {
  ...
  const apiKey =
    process.env.PUBLIC_ACCESS_KEY || "5e9b6863-615a-4c30-986f-0ec1d234fb64";
            ...
            >
              <defs>
                ...
                >
                  ...
                  <stop offset="1" stopColor="#e0e0ff" stopOpacity=".24" />
                </linearGradient>
              </defs>
              <path
                fillRule="evenodd"
          ...
          <div className="relative flex flex-col lg:flex-row justify-between items-center">
            ...
            >
              ...
              <p className="text-purple-300 text-lg italic">
                send us a message and get a quickly response
              </p>
              <p className="text-purple-100 text-lg italic">
                <a
                  className="hover:underline"
                  href="mailto:contact@creative66.com"
                >
                  contact@creative66.com
                </a>
              </p>
              <br />
              <p className="text-purple-300 text-lg italic">
            ...
            <form onSubmit={handleSubmit(onSubmit)} className="w-full lg:w-1/2">
              <div className="col-2 w-full">
                <div className="flex flex-col sm:flex-row gap-2 mb-2">
                  ...
                  <div className="name input w-full">
                    <input
                      id="name-form"
                      type="text"
                      className="w-full bg-purple-700 border border-purple-500 focus:border-purple-300 rounded-sm py-3 mb-2 sm:mb-0 sm:mr-2 text-white placeholder-purple-400"
                ...
                <div className="mb-2">
                  <select
                    className="w-full bg-purple-700 border-purple-500 border rounded-sm py-3 mb-2 sm:mb-0 sm:mr-2 text-white"
                    placeholder="teste"
                    required
                    {...register("subject", {
                  ...
                  >
                    <option value="" key="subject" selected hidden>
                      select a subject
                    </option>
                    {menuItems.map((menu_items, index) => {
                      return (
                        <option
                          className=" bg-purple-500 border border-purple-500 focus:border-purple-300 rounded-sm py-3 mb-2 sm:mb-0 sm:mr-2 placeholder-purple-400"
                          value={menu_items}
                          key={index}
                        >
                          {menu_items}
                ...
                <div className="message form">
                  <textarea
                    id="message-form"
                    rows={4}
                    className="w-full bg-purple-700 border border-purple-500 focus:border-purple-300 rounded-sm px-4 py-3 mb-2 sm:mb-0 sm:mr-2 text-white placeholder-purple-400"
                ...
                <button
                  className="btn text-purple-600 bg-purple-100 hover:bg-white shadow w-full mt-1"
                  type="submit"
                >
                  send
                </button>
                ...
                {isSubmitSuccessful && !isSuccess && (
                  <div className="mt-3 text-sm text-center text-red-200">
                    {message ||
                      "❌ Oops, error! Message not sent, please try again. If error persists, you can send it directly to <contact[@]creative66.com>"}
                  </div>
                )}
              </div>
            </form>
