        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6">
          ...
          <div className="grid md:grid-cols-12 gap-8 lg:gap-20 mb-8 md:mb-12">
            ...
            <div className="md:col-span-4 lg:col-span-5">
              ...
              <div className="text-gray-400">Creative66 is the right place for all your needs in Counter-Strike. We build maps, server plugins, configs and much more. Contact us.</div>
            </div>
            ...
            <div className="md:col-span-8 lg:col-span-7">
              ...
              <div className="text-sm">
                <h6 className="text-gray-200 font-medium mb-1">We do</h6>
                <ul>
                  <li className="mb-1">
                    <Link href="#maps" className="text-gray-400 hover:text-gray-100 transition duration-150 ease-in-out">Maps</Link>
                  </li>
                  <li className="mb-1">
                    <Link href="#server-plugins" className="text-gray-400 hover:text-gray-100 transition duration-150 ease-in-out">Server plugins</Link>
                  </li>
                  <li className="mb-1">
                    <Link href="#server-configs" className="text-gray-400 hover:text-gray-100 transition duration-150 ease-in-out">Server configs</Link>
                  </li>
                </ul>
              </div>
          ...
          <div className="md:flex md:items-center md:justify-between">
            ...
            {/* Copyrights note */}
            <div className="text-gray-400 text-sm mr-4">&copy; Creative66.com. All rights reserved.</div>
